...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
    	...
    	KC_TAB    ,KC_A    ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_H    ,KC_J    ,KC_K    ,KC_L    ,KC_SLSH ,
    	KC_LSFT       ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_RSFT       ,
    	      KC_RCTL ,KC_LGUI ,KC_LALT ,KC_DEL  ,LT(1, KC_SPC),LT(2, KC_SPC),KC_BSPC ,KC_RALT ,OSL(3)  ,KC_RCTL
    ),
	
    [1] = LAYOUT(
        KC_GRV  ,KC_1    ,KC_2    ,KC_3    ,KC_4    ,KC_5    ,KC_6    ,KC_7    ,KC_8    ,KC_9    ,KC_0    ,KC_TRNS     ,
    	KC_CAPS   ,KC_MINS ,KC_EQL  ,KC_INT3 ,KC_LBRC ,KC_RBRC ,KC_NUHS ,KC_SCLN ,KC_QUOT ,KC_INT1 ,KC_TRNS ,
